...
/* ── HERO ── */
.cfh-hero {
  background:linear-gradient(135deg,#080F1A 0%,#0C1E35 40%,#091828 100%);
  border-radius:var(--r-xl); padding:44px 48px; margin-bottom:32px;
...
const TECHNICIANS = [
  { initials:'RK', name:'Ram Kumar Shrestha', role:'AC Installation Expert',  tags:['LG','Daikin','Samsung'],       rating:4.9, jobs:312, exp:'8 yrs', online:true,  grad:'linear-gradient(135deg,#00C9C8,#1E6FDB)' },
  { initials:'ST', name:'Sita Tamang',         role:'Gas Refill Specialist',   tags:['R32','R410A','R22'],            rating:4.8, jobs:187, exp:'5 yrs', online:true,  grad:'linear-gradient(135deg,#F59E0B,#EF4444)' },
  { initials:'PG', name:'Prabin Gurung',        role:'Refrigeration Engineer',  tags:['Fridge','Freezer','Cold Room'],rating:4.7, jobs:264, exp:'7 yrs', online:false, grad:'linear-gradient(135deg,#22C55E,#16A34A)' },
  { initials:'AM', name:'Anita Maharjan',       role:'PCB & Electronics Tech',  tags:['PCB','Inverter','Smart AC'],   rating:4.9, jobs:98,  exp:'4 yrs', online:true,  grad:'linear-gradient(135deg,#8B5CF6,#EC4899)' },
  { initials:'BT', name:'Bikash Thapa',         role:'AC & Fridge All-rounder', tags:['All Brands','Emergency'],      rating:4.6, jobs:445, exp:'10 yrs',online:false, grad:'linear-gradient(135deg,#FF6B35,#D4512A)' },
  { initials:'DS', name:'Deepa Shrestha',       role:'HVAC System Technician',  tags:['Central AC','Duct','VRF'],     rating:4.8, jobs:156, exp:'6 yrs', online:true,  grad:'linear-gradient(135deg,#06B6D4,#0284C7)' },
];
    ...
    <div id="cfh-root" data-theme={dark ? 'dark' : ''} className="cfh-shell">
      ...
      <div className="cfh-topbar">
        <div className="cfh-logo" onClick={() => nav('home')}>
          ...
          <div className="cfh-logo-text">Cool<em>Fix</em>Hub</div>
        </div>
